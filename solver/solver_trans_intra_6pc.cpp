...
#include <Eigen/Dense>
#include "common.h"
#include "solver_trans_intra_6pc_core_48.h"
...
{
    const VectorXd data = Map<const VectorXd>(input, 1315);
    Eigen::MatrixXcd sols = solver_trans_intra_6pc_core_48(data);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) 
{
    ...
    {
        mexErrMsgIdAndTxt("JPL:tr_intra_6pc:notDouble", "Input data must be type double.");
    }
    
    bool is_known_angle = false;
    PC_TYPE pctype = PC_TYPE::PC_INTRA_CAM_CONSTRAINT_FULL;
    double *Image_1;
    double *Image_2;
